...
// AssertDomainRequired checks if the required fields are not zero-ed
func AssertDomainRequired(obj Domain) error {
	if err := AssertMediaFileRequired(obj.AdditionalInfo); err != nil {
		return err
	}
	return nil
}

// AssertDomainConstraints checks if the values respects the defined constraints
func AssertDomainConstraints(obj Domain) error {
	return nil
}
