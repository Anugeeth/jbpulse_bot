...
// AssertFormRequired checks if the required fields are not zero-ed
func AssertFormRequired(obj Form) error {
	return nil
}

// AssertFormConstraints checks if the values respects the defined constraints
func AssertFormConstraints(obj Form) error {
	return nil
}
