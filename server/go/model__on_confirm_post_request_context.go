...
type OnConfirmPostRequestContext struct {
...
// AssertOnConfirmPostRequestContextRequired checks if the required fields are not zero-ed
func AssertOnConfirmPostRequestContextRequired(obj OnConfirmPostRequestContext) error {
...
// AssertOnConfirmPostRequestContextConstraints checks if the values respects the defined constraints
func AssertOnConfirmPostRequestContextConstraints(obj OnConfirmPostRequestContext) error {
	return nil
}
