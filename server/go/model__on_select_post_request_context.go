...
type OnSelectPostRequestContext struct {
...
// AssertOnSelectPostRequestContextRequired checks if the required fields are not zero-ed
func AssertOnSelectPostRequestContextRequired(obj OnSelectPostRequestContext) error {
...
// AssertOnSelectPostRequestContextConstraints checks if the values respects the defined constraints
func AssertOnSelectPostRequestContextConstraints(obj OnSelectPostRequestContext) error {
	return nil
}
