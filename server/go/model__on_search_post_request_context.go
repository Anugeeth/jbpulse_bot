...
type OnSearchPostRequestContext struct {
...
// AssertOnSearchPostRequestContextRequired checks if the required fields are not zero-ed
func AssertOnSearchPostRequestContextRequired(obj OnSearchPostRequestContext) error {
...
// AssertOnSearchPostRequestContextConstraints checks if the values respects the defined constraints
func AssertOnSearchPostRequestContextConstraints(obj OnSearchPostRequestContext) error {
	return nil
}
