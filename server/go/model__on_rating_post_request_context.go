...
type OnRatingPostRequestContext struct {
...
// AssertOnRatingPostRequestContextRequired checks if the required fields are not zero-ed
func AssertOnRatingPostRequestContextRequired(obj OnRatingPostRequestContext) error {
...
// AssertOnRatingPostRequestContextConstraints checks if the values respects the defined constraints
func AssertOnRatingPostRequestContextConstraints(obj OnRatingPostRequestContext) error {
	return nil
}
