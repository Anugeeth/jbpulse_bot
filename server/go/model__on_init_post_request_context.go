...
type OnInitPostRequestContext struct {
...
// AssertOnInitPostRequestContextRequired checks if the required fields are not zero-ed
func AssertOnInitPostRequestContextRequired(obj OnInitPostRequestContext) error {
...
// AssertOnInitPostRequestContextConstraints checks if the values respects the defined constraints
func AssertOnInitPostRequestContextConstraints(obj OnInitPostRequestContext) error {
	return nil
}
