...
type OnStatusPostRequestContext struct {
...
// AssertOnStatusPostRequestContextRequired checks if the required fields are not zero-ed
func AssertOnStatusPostRequestContextRequired(obj OnStatusPostRequestContext) error {
...
// AssertOnStatusPostRequestContextConstraints checks if the values respects the defined constraints
func AssertOnStatusPostRequestContextConstraints(obj OnStatusPostRequestContext) error {
	return nil
}
