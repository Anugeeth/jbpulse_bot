...
type OnSupportPostRequestContext struct {
...
// AssertOnSupportPostRequestContextRequired checks if the required fields are not zero-ed
func AssertOnSupportPostRequestContextRequired(obj OnSupportPostRequestContext) error {
...
// AssertOnSupportPostRequestContextConstraints checks if the values respects the defined constraints
func AssertOnSupportPostRequestContextConstraints(obj OnSupportPostRequestContext) error {
	return nil
}
