...
/**
 * The InitPostRequestContext model module.
 * @module model/InitPostRequestContext
 * @version 1.1.0
 */
class InitPostRequestContext {
    /**
     * Constructs a new <code>InitPostRequestContext</code>.
     * @alias module:model/InitPostRequestContext
     * @implements module:model/Context
     * @param action {module:model/InitPostRequestContext.ActionEnum} 
     */
    constructor(action) { 
        Context.initialize(this);
        InitPostRequestContext.initialize(this, action);
    }
    ...
    /**
     * Constructs a <code>InitPostRequestContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitPostRequestContext} obj Optional instance to populate.
     * @return {module:model/InitPostRequestContext} The populated <code>InitPostRequestContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitPostRequestContext();
    ...
    /**
     * Validates the JSON data with respect to <code>InitPostRequestContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitPostRequestContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InitPostRequestContext.RequiredProperties) {
            if (!data[property]) {
...
InitPostRequestContext.RequiredProperties = ["action"];

/**
 * @member {module:model/Code} domain
 */
InitPostRequestContext.prototype['domain'] = undefined;

/**
 * @member {module:model/Location} location
 */
InitPostRequestContext.prototype['location'] = undefined;

/**
 * @member {module:model/InitPostRequestContext.ActionEnum} action
 */
InitPostRequestContext.prototype['action'] = undefined;

/**
 * Version of transaction protocol being used by the sender.
 * @member {String} version
 */
InitPostRequestContext.prototype['version'] = undefined;
 ...
 */
InitPostRequestContext.prototype['bap_id'] = undefined;
 ...
 */
InitPostRequestContext.prototype['bap_uri'] = undefined;

/**
 * @member {module:model/Model0} bpp_id
 */
InitPostRequestContext.prototype['bpp_id'] = undefined;

/**
 * @member {module:model/Model0} bpp_uri
 */
InitPostRequestContext.prototype['bpp_uri'] = undefined;
 ...
 */
InitPostRequestContext.prototype['transaction_id'] = undefined;
 ...
 */
InitPostRequestContext.prototype['message_id'] = undefined;

/**
 * Time of request generation in RFC3339 format
 * @member {Date} timestamp
 */
InitPostRequestContext.prototype['timestamp'] = undefined;

/**
 * The encryption public key of the sender
 * @member {String} key
 */
InitPostRequestContext.prototype['key'] = undefined;

/**
 * The duration in ISO8601 format after timestamp for which this message holds valid
 * @member {String} ttl
 */
InitPostRequestContext.prototype['ttl'] = undefined;
 ...
 * @readonly
 */
InitPostRequestContext['ActionEnum'] = {
...
export default InitPostRequestContext;
