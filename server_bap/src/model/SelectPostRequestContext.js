...
/**
 * The SelectPostRequestContext model module.
 * @module model/SelectPostRequestContext
 * @version 1.1.0
 */
class SelectPostRequestContext {
    /**
     * Constructs a new <code>SelectPostRequestContext</code>.
     * @alias module:model/SelectPostRequestContext
     * @implements module:model/Context
     * @param action {module:model/SelectPostRequestContext.ActionEnum} 
     */
    constructor(action) { 
        Context.initialize(this);
        SelectPostRequestContext.initialize(this, action);
    }
    ...
    /**
     * Constructs a <code>SelectPostRequestContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SelectPostRequestContext} obj Optional instance to populate.
     * @return {module:model/SelectPostRequestContext} The populated <code>SelectPostRequestContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SelectPostRequestContext();
    ...
    /**
     * Validates the JSON data with respect to <code>SelectPostRequestContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SelectPostRequestContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SelectPostRequestContext.RequiredProperties) {
            if (!data[property]) {
...
SelectPostRequestContext.RequiredProperties = ["action"];

/**
 * @member {module:model/Code} domain
 */
SelectPostRequestContext.prototype['domain'] = undefined;

/**
 * @member {module:model/Location} location
 */
SelectPostRequestContext.prototype['location'] = undefined;

/**
 * @member {module:model/SelectPostRequestContext.ActionEnum} action
 */
SelectPostRequestContext.prototype['action'] = undefined;

/**
 * Version of transaction protocol being used by the sender.
 * @member {String} version
 */
SelectPostRequestContext.prototype['version'] = undefined;
 ...
 */
SelectPostRequestContext.prototype['bap_id'] = undefined;
 ...
 */
SelectPostRequestContext.prototype['bap_uri'] = undefined;

/**
 * @member {module:model/Model0} bpp_id
 */
SelectPostRequestContext.prototype['bpp_id'] = undefined;

/**
 * @member {module:model/Model0} bpp_uri
 */
SelectPostRequestContext.prototype['bpp_uri'] = undefined;
 ...
 */
SelectPostRequestContext.prototype['transaction_id'] = undefined;
 ...
 */
SelectPostRequestContext.prototype['message_id'] = undefined;

/**
 * Time of request generation in RFC3339 format
 * @member {Date} timestamp
 */
SelectPostRequestContext.prototype['timestamp'] = undefined;

/**
 * The encryption public key of the sender
 * @member {String} key
 */
SelectPostRequestContext.prototype['key'] = undefined;

/**
 * The duration in ISO8601 format after timestamp for which this message holds valid
 * @member {String} ttl
 */
SelectPostRequestContext.prototype['ttl'] = undefined;
 ...
 * @readonly
 */
SelectPostRequestContext['ActionEnum'] = {
...
export default SelectPostRequestContext;
