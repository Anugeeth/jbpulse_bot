...
/**
 * The UpdatePostRequestContext model module.
 * @module model/UpdatePostRequestContext
 * @version 1.1.0
 */
class UpdatePostRequestContext {
    /**
     * Constructs a new <code>UpdatePostRequestContext</code>.
     * @alias module:model/UpdatePostRequestContext
     * @implements module:model/Context
     * @param action {module:model/UpdatePostRequestContext.ActionEnum} 
     */
    constructor(action) { 
        Context.initialize(this);
        UpdatePostRequestContext.initialize(this, action);
    }
    ...
    /**
     * Constructs a <code>UpdatePostRequestContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePostRequestContext} obj Optional instance to populate.
     * @return {module:model/UpdatePostRequestContext} The populated <code>UpdatePostRequestContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePostRequestContext();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePostRequestContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePostRequestContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePostRequestContext.RequiredProperties) {
            if (!data[property]) {
...
UpdatePostRequestContext.RequiredProperties = ["action"];

/**
 * @member {module:model/Code} domain
 */
UpdatePostRequestContext.prototype['domain'] = undefined;

/**
 * @member {module:model/Location} location
 */
UpdatePostRequestContext.prototype['location'] = undefined;

/**
 * @member {module:model/UpdatePostRequestContext.ActionEnum} action
 */
UpdatePostRequestContext.prototype['action'] = undefined;

/**
 * Version of transaction protocol being used by the sender.
 * @member {String} version
 */
UpdatePostRequestContext.prototype['version'] = undefined;
 ...
 */
UpdatePostRequestContext.prototype['bap_id'] = undefined;
 ...
 */
UpdatePostRequestContext.prototype['bap_uri'] = undefined;

/**
 * @member {module:model/Model0} bpp_id
 */
UpdatePostRequestContext.prototype['bpp_id'] = undefined;

/**
 * @member {module:model/Model0} bpp_uri
 */
UpdatePostRequestContext.prototype['bpp_uri'] = undefined;
 ...
 */
UpdatePostRequestContext.prototype['transaction_id'] = undefined;
 ...
 */
UpdatePostRequestContext.prototype['message_id'] = undefined;

/**
 * Time of request generation in RFC3339 format
 * @member {Date} timestamp
 */
UpdatePostRequestContext.prototype['timestamp'] = undefined;

/**
 * The encryption public key of the sender
 * @member {String} key
 */
UpdatePostRequestContext.prototype['key'] = undefined;

/**
 * The duration in ISO8601 format after timestamp for which this message holds valid
 * @member {String} ttl
 */
UpdatePostRequestContext.prototype['ttl'] = undefined;
 ...
 * @readonly
 */
UpdatePostRequestContext['ActionEnum'] = {
...
export default UpdatePostRequestContext;
