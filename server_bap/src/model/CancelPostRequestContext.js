...
/**
 * The CancelPostRequestContext model module.
 * @module model/CancelPostRequestContext
 * @version 1.1.0
 */
class CancelPostRequestContext {
    /**
     * Constructs a new <code>CancelPostRequestContext</code>.
     * @alias module:model/CancelPostRequestContext
     * @implements module:model/Context
     * @param action {module:model/CancelPostRequestContext.ActionEnum} 
     */
    constructor(action) { 
        Context.initialize(this);
        CancelPostRequestContext.initialize(this, action);
    }
    ...
    /**
     * Constructs a <code>CancelPostRequestContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelPostRequestContext} obj Optional instance to populate.
     * @return {module:model/CancelPostRequestContext} The populated <code>CancelPostRequestContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelPostRequestContext();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelPostRequestContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelPostRequestContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelPostRequestContext.RequiredProperties) {
            if (!data[property]) {
...
CancelPostRequestContext.RequiredProperties = ["action"];

/**
 * @member {module:model/Code} domain
 */
CancelPostRequestContext.prototype['domain'] = undefined;

/**
 * @member {module:model/Location} location
 */
CancelPostRequestContext.prototype['location'] = undefined;

/**
 * @member {module:model/CancelPostRequestContext.ActionEnum} action
 */
CancelPostRequestContext.prototype['action'] = undefined;

/**
 * Version of transaction protocol being used by the sender.
 * @member {String} version
 */
CancelPostRequestContext.prototype['version'] = undefined;
 ...
 */
CancelPostRequestContext.prototype['bap_id'] = undefined;
 ...
 */
CancelPostRequestContext.prototype['bap_uri'] = undefined;

/**
 * @member {module:model/Model0} bpp_id
 */
CancelPostRequestContext.prototype['bpp_id'] = undefined;

/**
 * @member {module:model/Model0} bpp_uri
 */
CancelPostRequestContext.prototype['bpp_uri'] = undefined;
 ...
 */
CancelPostRequestContext.prototype['transaction_id'] = undefined;
 ...
 */
CancelPostRequestContext.prototype['message_id'] = undefined;

/**
 * Time of request generation in RFC3339 format
 * @member {Date} timestamp
 */
CancelPostRequestContext.prototype['timestamp'] = undefined;

/**
 * The encryption public key of the sender
 * @member {String} key
 */
CancelPostRequestContext.prototype['key'] = undefined;

/**
 * The duration in ISO8601 format after timestamp for which this message holds valid
 * @member {String} ttl
 */
CancelPostRequestContext.prototype['ttl'] = undefined;
 ...
 * @readonly
 */
CancelPostRequestContext['ActionEnum'] = {
...
export default CancelPostRequestContext;
