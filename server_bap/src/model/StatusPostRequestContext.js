...
/**
 * The StatusPostRequestContext model module.
 * @module model/StatusPostRequestContext
 * @version 1.1.0
 */
class StatusPostRequestContext {
    /**
     * Constructs a new <code>StatusPostRequestContext</code>.
     * @alias module:model/StatusPostRequestContext
     * @implements module:model/Context
     * @param action {module:model/StatusPostRequestContext.ActionEnum} 
     */
    constructor(action) { 
        Context.initialize(this);
        StatusPostRequestContext.initialize(this, action);
    }
    ...
    /**
     * Constructs a <code>StatusPostRequestContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatusPostRequestContext} obj Optional instance to populate.
     * @return {module:model/StatusPostRequestContext} The populated <code>StatusPostRequestContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusPostRequestContext();
    ...
    /**
     * Validates the JSON data with respect to <code>StatusPostRequestContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatusPostRequestContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatusPostRequestContext.RequiredProperties) {
            if (!data[property]) {
...
StatusPostRequestContext.RequiredProperties = ["action"];

/**
 * @member {module:model/Code} domain
 */
StatusPostRequestContext.prototype['domain'] = undefined;

/**
 * @member {module:model/Location} location
 */
StatusPostRequestContext.prototype['location'] = undefined;

/**
 * @member {module:model/StatusPostRequestContext.ActionEnum} action
 */
StatusPostRequestContext.prototype['action'] = undefined;

/**
 * Version of transaction protocol being used by the sender.
 * @member {String} version
 */
StatusPostRequestContext.prototype['version'] = undefined;
 ...
 */
StatusPostRequestContext.prototype['bap_id'] = undefined;
 ...
 */
StatusPostRequestContext.prototype['bap_uri'] = undefined;

/**
 * @member {module:model/Model0} bpp_id
 */
StatusPostRequestContext.prototype['bpp_id'] = undefined;

/**
 * @member {module:model/Model0} bpp_uri
 */
StatusPostRequestContext.prototype['bpp_uri'] = undefined;
 ...
 */
StatusPostRequestContext.prototype['transaction_id'] = undefined;
 ...
 */
StatusPostRequestContext.prototype['message_id'] = undefined;

/**
 * Time of request generation in RFC3339 format
 * @member {Date} timestamp
 */
StatusPostRequestContext.prototype['timestamp'] = undefined;

/**
 * The encryption public key of the sender
 * @member {String} key
 */
StatusPostRequestContext.prototype['key'] = undefined;

/**
 * The duration in ISO8601 format after timestamp for which this message holds valid
 * @member {String} ttl
 */
StatusPostRequestContext.prototype['ttl'] = undefined;
 ...
 * @readonly
 */
StatusPostRequestContext['ActionEnum'] = {
...
export default StatusPostRequestContext;
