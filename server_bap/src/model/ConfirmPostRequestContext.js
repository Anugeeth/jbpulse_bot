...
/**
 * The ConfirmPostRequestContext model module.
 * @module model/ConfirmPostRequestContext
 * @version 1.1.0
 */
class ConfirmPostRequestContext {
    /**
     * Constructs a new <code>ConfirmPostRequestContext</code>.
     * @alias module:model/ConfirmPostRequestContext
     * @implements module:model/Context
     * @param action {module:model/ConfirmPostRequestContext.ActionEnum} 
     */
    constructor(action) { 
        Context.initialize(this);
        ConfirmPostRequestContext.initialize(this, action);
    }
    ...
    /**
     * Constructs a <code>ConfirmPostRequestContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmPostRequestContext} obj Optional instance to populate.
     * @return {module:model/ConfirmPostRequestContext} The populated <code>ConfirmPostRequestContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmPostRequestContext();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmPostRequestContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmPostRequestContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConfirmPostRequestContext.RequiredProperties) {
            if (!data[property]) {
...
ConfirmPostRequestContext.RequiredProperties = ["action"];

/**
 * @member {module:model/Code} domain
 */
ConfirmPostRequestContext.prototype['domain'] = undefined;

/**
 * @member {module:model/Location} location
 */
ConfirmPostRequestContext.prototype['location'] = undefined;

/**
 * @member {module:model/ConfirmPostRequestContext.ActionEnum} action
 */
ConfirmPostRequestContext.prototype['action'] = undefined;

/**
 * Version of transaction protocol being used by the sender.
 * @member {String} version
 */
ConfirmPostRequestContext.prototype['version'] = undefined;
 ...
 */
ConfirmPostRequestContext.prototype['bap_id'] = undefined;
 ...
 */
ConfirmPostRequestContext.prototype['bap_uri'] = undefined;

/**
 * @member {module:model/Model0} bpp_id
 */
ConfirmPostRequestContext.prototype['bpp_id'] = undefined;

/**
 * @member {module:model/Model0} bpp_uri
 */
ConfirmPostRequestContext.prototype['bpp_uri'] = undefined;
 ...
 */
ConfirmPostRequestContext.prototype['transaction_id'] = undefined;
 ...
 */
ConfirmPostRequestContext.prototype['message_id'] = undefined;

/**
 * Time of request generation in RFC3339 format
 * @member {Date} timestamp
 */
ConfirmPostRequestContext.prototype['timestamp'] = undefined;

/**
 * The encryption public key of the sender
 * @member {String} key
 */
ConfirmPostRequestContext.prototype['key'] = undefined;

/**
 * The duration in ISO8601 format after timestamp for which this message holds valid
 * @member {String} ttl
 */
ConfirmPostRequestContext.prototype['ttl'] = undefined;
 ...
 * @readonly
 */
ConfirmPostRequestContext['ActionEnum'] = {
...
export default ConfirmPostRequestContext;
