...
/**
 * The RatingPostRequestContext model module.
 * @module model/RatingPostRequestContext
 * @version 1.1.0
 */
class RatingPostRequestContext {
    /**
     * Constructs a new <code>RatingPostRequestContext</code>.
     * @alias module:model/RatingPostRequestContext
     * @implements module:model/Context
     * @param action {module:model/RatingPostRequestContext.ActionEnum} 
     */
    constructor(action) { 
        Context.initialize(this);
        RatingPostRequestContext.initialize(this, action);
    }
    ...
    /**
     * Constructs a <code>RatingPostRequestContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RatingPostRequestContext} obj Optional instance to populate.
     * @return {module:model/RatingPostRequestContext} The populated <code>RatingPostRequestContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RatingPostRequestContext();
    ...
    /**
     * Validates the JSON data with respect to <code>RatingPostRequestContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RatingPostRequestContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RatingPostRequestContext.RequiredProperties) {
            if (!data[property]) {
...
RatingPostRequestContext.RequiredProperties = ["action"];

/**
 * @member {module:model/Code} domain
 */
RatingPostRequestContext.prototype['domain'] = undefined;

/**
 * @member {module:model/Location} location
 */
RatingPostRequestContext.prototype['location'] = undefined;

/**
 * @member {module:model/RatingPostRequestContext.ActionEnum} action
 */
RatingPostRequestContext.prototype['action'] = undefined;

/**
 * Version of transaction protocol being used by the sender.
 * @member {String} version
 */
RatingPostRequestContext.prototype['version'] = undefined;
 ...
 */
RatingPostRequestContext.prototype['bap_id'] = undefined;
 ...
 */
RatingPostRequestContext.prototype['bap_uri'] = undefined;

/**
 * @member {module:model/Model0} bpp_id
 */
RatingPostRequestContext.prototype['bpp_id'] = undefined;

/**
 * @member {module:model/Model0} bpp_uri
 */
RatingPostRequestContext.prototype['bpp_uri'] = undefined;
 ...
 */
RatingPostRequestContext.prototype['transaction_id'] = undefined;
 ...
 */
RatingPostRequestContext.prototype['message_id'] = undefined;

/**
 * Time of request generation in RFC3339 format
 * @member {Date} timestamp
 */
RatingPostRequestContext.prototype['timestamp'] = undefined;

/**
 * The encryption public key of the sender
 * @member {String} key
 */
RatingPostRequestContext.prototype['key'] = undefined;

/**
 * The duration in ISO8601 format after timestamp for which this message holds valid
 * @member {String} ttl
 */
RatingPostRequestContext.prototype['ttl'] = undefined;
 ...
 * @readonly
 */
RatingPostRequestContext['ActionEnum'] = {
...
export default RatingPostRequestContext;
