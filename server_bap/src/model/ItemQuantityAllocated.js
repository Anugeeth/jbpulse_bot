...
class ItemQuantityAllocated {
    ...
    constructor() { 
        ...
        ItemQuantityAllocated.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemQuantityAllocated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemQuantityAllocated</code>.
     */
...
export default ItemQuantityAllocated;
