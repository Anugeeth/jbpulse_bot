...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.FulfillmentState();
  });
  ...
  describe('FulfillmentState', function() {
    it('should create an instance of FulfillmentState', function() {
      // uncomment below and update the code to test FulfillmentState
      //var instance = new BecknOdrApiSpecification.FulfillmentState();
      //expect(instance).to.be.a(BecknOdrApiSpecification.FulfillmentState);
    });
