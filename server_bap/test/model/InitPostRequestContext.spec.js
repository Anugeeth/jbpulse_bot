...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.InitPostRequestContext();
  });
  ...
  describe('InitPostRequestContext', function() {
    it('should create an instance of InitPostRequestContext', function() {
      // uncomment below and update the code to test InitPostRequestContext
      //var instance = new BecknOdrApiSpecification.InitPostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.InitPostRequestContext);
    });
