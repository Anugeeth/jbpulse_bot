...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.RatingPostRequestContext();
  });
  ...
  describe('RatingPostRequestContext', function() {
    it('should create an instance of RatingPostRequestContext', function() {
      // uncomment below and update the code to test RatingPostRequestContext
      //var instance = new BecknOdrApiSpecification.RatingPostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.RatingPostRequestContext);
    });
