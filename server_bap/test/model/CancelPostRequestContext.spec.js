...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.CancelPostRequestContext();
  });
  ...
  describe('CancelPostRequestContext', function() {
    it('should create an instance of CancelPostRequestContext', function() {
      // uncomment below and update the code to test CancelPostRequestContext
      //var instance = new BecknOdrApiSpecification.CancelPostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.CancelPostRequestContext);
    });
