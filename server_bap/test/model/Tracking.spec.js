...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.Tracking();
  });
  ...
  describe('Tracking', function() {
    it('should create an instance of Tracking', function() {
      ...
      //var instance = new BecknOdrApiSpecification.Tracking();
      //expect(instance).to.be.a(BecknOdrApiSpecification.Tracking);
    });
