...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.Country();
  });
  ...
  describe('Country', function() {
    it('should create an instance of Country', function() {
      ...
      //var instance = new BecknOdrApiSpecification.Country();
      //expect(instance).to.be.a(BecknOdrApiSpecification.Country);
    });
