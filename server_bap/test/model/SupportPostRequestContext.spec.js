...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.SupportPostRequestContext();
  });
  ...
  describe('SupportPostRequestContext', function() {
    it('should create an instance of SupportPostRequestContext', function() {
      // uncomment below and update the code to test SupportPostRequestContext
      //var instance = new BecknOdrApiSpecification.SupportPostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.SupportPostRequestContext);
    });
