...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.ScalarRange();
  });
  ...
  describe('ScalarRange', function() {
    it('should create an instance of ScalarRange', function() {
      // uncomment below and update the code to test ScalarRange
      //var instance = new BecknOdrApiSpecification.ScalarRange();
      //expect(instance).to.be.a(BecknOdrApiSpecification.ScalarRange);
    });
