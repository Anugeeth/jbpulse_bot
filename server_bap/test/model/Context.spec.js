...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.Context();
  });
  ...
  describe('Context', function() {
    it('should create an instance of Context', function() {
      ...
      //var instance = new BecknOdrApiSpecification.Context();
      //expect(instance).to.be.a(BecknOdrApiSpecification.Context);
    });
