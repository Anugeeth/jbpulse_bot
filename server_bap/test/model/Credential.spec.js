...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.Credential();
  });
  ...
  describe('Credential', function() {
    it('should create an instance of Credential', function() {
      ...
      //var instance = new BecknOdrApiSpecification.Credential();
      //expect(instance).to.be.a(BecknOdrApiSpecification.Credential);
    });
