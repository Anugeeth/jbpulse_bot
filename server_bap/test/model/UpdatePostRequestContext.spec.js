...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.UpdatePostRequestContext();
  });
  ...
  describe('UpdatePostRequestContext', function() {
    it('should create an instance of UpdatePostRequestContext', function() {
      // uncomment below and update the code to test UpdatePostRequestContext
      //var instance = new BecknOdrApiSpecification.UpdatePostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.UpdatePostRequestContext);
    });
