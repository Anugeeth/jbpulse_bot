...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.SearchPostRequestContext();
  });
  ...
  describe('SearchPostRequestContext', function() {
    it('should create an instance of SearchPostRequestContext', function() {
      // uncomment below and update the code to test SearchPostRequestContext
      //var instance = new BecknOdrApiSpecification.SearchPostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.SearchPostRequestContext);
    });
