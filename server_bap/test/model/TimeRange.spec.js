...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.TimeRange();
  });
  ...
  describe('TimeRange', function() {
    it('should create an instance of TimeRange', function() {
      ...
      //var instance = new BecknOdrApiSpecification.TimeRange();
      //expect(instance).to.be.a(BecknOdrApiSpecification.TimeRange);
    });
