...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.Category();
  });
  ...
  describe('Category', function() {
    it('should create an instance of Category', function() {
      ...
      //var instance = new BecknOdrApiSpecification.Category();
      //expect(instance).to.be.a(BecknOdrApiSpecification.Category);
    });
