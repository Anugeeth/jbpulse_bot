...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.ItemQuantityMaximum();
  });
  ...
  describe('ItemQuantityMaximum', function() {
    it('should create an instance of ItemQuantityMaximum', function() {
      // uncomment below and update the code to test ItemQuantityMaximum
      //var instance = new BecknOdrApiSpecification.ItemQuantityMaximum();
      //expect(instance).to.be.a(BecknOdrApiSpecification.ItemQuantityMaximum);
    });
