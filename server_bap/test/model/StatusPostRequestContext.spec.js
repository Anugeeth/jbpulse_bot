...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.StatusPostRequestContext();
  });
  ...
  describe('StatusPostRequestContext', function() {
    it('should create an instance of StatusPostRequestContext', function() {
      // uncomment below and update the code to test StatusPostRequestContext
      //var instance = new BecknOdrApiSpecification.StatusPostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.StatusPostRequestContext);
    });
