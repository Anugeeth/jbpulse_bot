...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BecknOdrApiSpecification.ConfirmPostRequestContext();
  });
  ...
  describe('ConfirmPostRequestContext', function() {
    it('should create an instance of ConfirmPostRequestContext', function() {
      // uncomment below and update the code to test ConfirmPostRequestContext
      //var instance = new BecknOdrApiSpecification.ConfirmPostRequestContext();
      //expect(instance).to.be.a(BecknOdrApiSpecification.ConfirmPostRequestContext);
    });
